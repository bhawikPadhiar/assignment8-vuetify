    ...
    <v-dialog v-model="dialog" width="auto">
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn color="blue-darken-1" variant="text" type="submit" value="Submit" @click="onSubmit">
            Save
          </v-btn>
        </v-card-actions>
      </v-card>
...
export default {
  ...
  data() {
    return {
       name:this.editCateData.name,
      description:this.editCateData.description,
       model:this.editCateData.model,
